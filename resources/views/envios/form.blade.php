        ...
        <div id="app">
            <div class="container">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" class="form-control w-25" placeholder="{{ __('messages.nameSurname') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="direccion" class="form-control w-50" placeholder="{{ __('messages.completeAddress') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="poblacion" class="form-control w-25" placeholder="{{ __('messages.townName') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="bultos" class="form-control w-10" placeholder="{{ Str::title(__('messages.packages')) }}" min="1"
                        max="100" value="{{ $envio ? $envio->bultos : '' }}" required>
                </div>
                {{-- Kilos --}}
                <div class="mb-3">
                    <label for="kilos">{{ __('messages.numberOfKilos') }}:</label>
                    <input type="number" name="kilos" class="form-control w-10" placeholder="{{ Str::title(__('messages.kilograms')) }}" step="0.01"
